...
public class SampleSemanticAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly LocalizableString MessageFormat = "Cannot set speed of spaceship to '{0}' as this would be faster than the speed of light";

    private static readonly LocalizableString Description = "A spaceship should not be able to go faster than the speed of light.";
